...
class VehicleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('vehicles')->insert([
            ...
            ['department_id' => 1, 'type' => 3, 'license_plate' => 'LEJ42-23HFZ', 'provider_name' => 'Touristique', 'description' => 'bus à 25 places', 'number_of_seats' => 25, 'price_per_hour' => 500, 'is_available' => 0, 'image' => 'https://fakeimg.pl/300/', 'contact_info' => 'info@ngaounderebus.com', 'website' => 'https://ngaounderebus.com'],
        ]);
    }
}
